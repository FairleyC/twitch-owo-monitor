...
const { getRedemptions, getRedemptionByUuid, isRedemptionUsable } = require('../../../redemptions/service');
...
router.post('/redemptions/:uuid', checkAuthentication, async function (req, res) {
    ...
    generateTrigger({ id: redemption.uuid, prefix: redemption.prefix, number: redemption.cost, triggered: false, errored: false, description: redemption.description });
    res.send('Test Triggered');
});
